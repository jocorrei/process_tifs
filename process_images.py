...
def process_tipo_folder(tipo_folder):
    ...
    for dirpath, dirnames, filenames in os.walk(tipo_folder):
        for filename in filenames:
            ...
            # Copy JPEG to TIF folder and convert to TIFF
            ...
            new_tif_path = os.path.join(new_tif_dir, os.path.basename(jpeg_path))
            shutil.copy(jpeg_path, new_tif_path)
            convert_jpeg_to_tiff(new_tif_path)
